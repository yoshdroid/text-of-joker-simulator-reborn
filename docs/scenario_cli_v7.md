...
| `dartagnan_cip_attack_draw` | ダルタニャン | `1-0-047` ダルタニャンをドライブしてCIPでCPが増え、その後アタック時効果でデッキトップを1枚引き、P2 LIFEが減る。 |  |
...
| `leafia_block_bp_modifier` | リーフィア | `1-0-045` リーフィアでブロックし、ブロック時BP修正が入り、ターン終了で修正が切れる。 |  |
