...
KNOWN_TIMINGS = {
    ...
    "TRIGGER_ANY",
    "TRIGGER_BATTLE_WON",
    "TRIGGER_PLAYER_ATTACK_SUCCESS",
    "TRIGGER_POST_BLOCK_CHOICE",
    "TRIGGER_UNIT_DESTROYED",
    "INTERCEPT_ANY",
    "INTERCEPT_ATTACK",
    "INTERCEPT_BATTLE",
    "INTERCEPT_BATTLE_WON",
    "INTERCEPT_PLAYER_ATTACK_SUCCESS",
    "INTERCEPT_TURN_STARTED",
    "PASSIVE",
    "TRIGGER_TURN_ENDED",
}
...
KNOWN_EFFECTS = {
    ...
    "modify_bp_units",
    "modify_base_bp",
    "modify_base_bp_units",
    "move_random_discard_to_hand",
    "move_card",
    "move_discard_to_hand",
    "recover_action",
    "recover_action_units",
    "return_unit_to_hand",
    "set_unit_level",
    "suppress_effects_for_battle",
}
